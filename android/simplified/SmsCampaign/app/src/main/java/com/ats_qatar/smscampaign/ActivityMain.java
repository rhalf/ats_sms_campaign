...
//        });
        ...
        GlobalScope.smsContainer = new SmsContainer();
        GlobalScope.setting = new Setting(this);
        GlobalScope.smsCampaignService = new SmsCampaignService(GlobalScope.setting, GlobalScope.smsContainer, this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_dashboard) {
            ...
            //Toast.makeText(this, "content_frame", Toast.LENGTH_SHORT).show();
            fragmentManager.beginTransaction()
